...
public class Meal {
    ...
    private String strDrinkAlternate; // Biasanya null untuk makanan
    ...
    private String strTags; // Bisa berupa string dipisahkan koma, atau null

    @SerializedName("strYoutube")
    private String strYoutube; // URL Video YouTube
    ...
    private String strSource; // URL sumber resep asli

    @SerializedName("strImageSource")
    private String strImageSource; // Biasanya null

    @SerializedName("strCreativeCommonsConfirmed")
    private String strCreativeCommonsConfirmed; // Biasanya null

    @SerializedName("dateModified")
    private String dateModified; // Biasanya null
    ...
    // ... tambahkan getter untuk strIngredient2 sampai strIngredient20
    ...
    // ... tambahkan getter untuk strMeasure2 sampai strMeasure20
    ...
    public List<String> getIngredientsWithMeasures() {
        ...
        for (int i = 0; i < ingredients.length; i++) {
            if (ingredients[i] != null && !ingredients[i].trim().isEmpty()) {
                ...
                // Hentikan jika bahan sudah null/kosong, karena biasanya berurutan
                break;
            }
        }
